...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue was using LIFO rather than FIFO. Sue was returned first.
    ...
    // Defect(s) Found: Sue was returned first because it added to the front of the queue in stack behavior.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Failing to output the correct order
    ...
    // Defect(s) Found: Beginning with Sue. 
